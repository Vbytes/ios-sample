    ...
    switch (indexPath.section) {
        case 0: {
            switch (indexPath.row) {
                case 0: {
                    [self.navigationController pushViewController:[[IJKDemoSampleViewController alloc] initWithFlag:true] animated:YES];
                } break;

                case 1:
                    [self.navigationController pushViewController:[[IJKDemoSampleViewController alloc] initWithFlag:false] animated:YES];
                    break;
                case 2:
        ...
        case 1: {
            ...
            [IJKVideoViewController presentFromViewController:self withTitle:historyItem.title URL:historyItem.url isLive:false completion:^{
